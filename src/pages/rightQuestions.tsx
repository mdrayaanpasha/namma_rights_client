    ...
    <div className="min-h-screen p-6 mt-20">
      <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              className="w-full p-4 bg-gray-900 text-white rounded-xl hover:bg-gray-800 
                active:scale-95 transition-transform font-medium flex justify-center items-center"
              disabled={submitting}
            >
              {submitting ? (
        ...
        <div className="flex flex-wrap justify-evenly gap-5">
          <div className="max-w-full p-6 bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 flex flex-col">
